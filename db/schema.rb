...
ActiveRecord::Schema.define(version: 20120420051746) do
  ...
  add_index "issues", ["repository_id", "open", "number"], name: "index_issues_on_repository_id_and_open_and_number", unique: true
  ...
  add_index "tree_entries", ["tree_id", "name"], name: "index_tree_entries_on_tree_id_and_name"
