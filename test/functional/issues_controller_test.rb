...
class IssuesControllerTest < ActionController::TestCase
  ...
  test "should not show the edit issue link when user can't read repo" do
  ...
  test "should not show new issue button when user can't read repo" do
    set_session_current_user users(:rms)
  ...
  test "should not show close issue button when user can't read repo" do
    set_session_current_user users(:rms)
    get :show, {:repo_name => @issue.repository.to_param, 
                :profile_name => @issue.repository.profile.to_param, 
                :id => @issue.to_param}
  ...
  test "should not be able to open issue when user can't read repo" do
    set_session_current_user users(:rms)
  ...
  test "should not be able to close issue when user can't read repo" do
    set_session_current_user users(:rms)
    put :update, :profile_name => @issue.repository.profile,
                 :repo_name => @issue.repository, 
