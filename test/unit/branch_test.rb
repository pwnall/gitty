...
class BranchTest < ActiveSupport::TestCase
  ...
  test 'from_git_branch' do
    ...
    git_easy_commit = @repo.rugged_repository.lookup(
    ...
    git_branch2 = @repo.rugged_repository.branches.
                        find { |b| b.name == 'branch2' }
    ...
    git_merge_commit = @repo.rugged_repository.lookup(
    ...
    git_branch_m = @repo.rugged_repository.branches.
